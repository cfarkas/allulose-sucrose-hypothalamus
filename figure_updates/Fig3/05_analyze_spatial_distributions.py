...
animal, DAPI centroids define six covariance-normalized radial shells that
...
ENDPOINTS = (
    EndpointSpec(
        "cfos_occurrence",
        "c-FOS-positive nuclei / DAPI nuclei spatial occurrence",
    ...
    EndpointSpec(
        "double_occurrence",
        "c-FOS and NPY double-positive nuclei / DAPI nuclei spatial occurrence",
        "c-FOS⁺NPY⁺ spatial occurrence",
        "c-FOS⁺NPY⁺ nuclei / DAPI nuclei (%)",
...
def extract_animal_features(
    ...
    for animal_order, sample in enumerate(samples, start=1):
        ...
        for shell_zero in range(N_RADIAL_SHELLS):
            ...
            if denominator <= 0:
                raise RuntimeError(f"Empty radial shell {shell_zero + 1}: {sample.animal_id}")
    ...
    try:
        ...
        provenance = {
            ...
            "method": {
                ...
                "occurrence_denominator": "DAPI nuclei in the same animal and radial shell",
            ...
            "caveats": [
                ...
                (
                    "The mandatory HIL-accepted WATER_NPY3 DAPI mask records the modal "
