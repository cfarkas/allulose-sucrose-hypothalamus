# Figure S1 scientific and statistical audit

## Decision

Figure S1 is an exploratory sex-stratified companion to Figure 1. It repeats the January single-bottle outcomes within male cages. It is not a treatment-by-sex interaction analysis and must not be interpreted as evidence that a treatment effect differs between sexes.

## Eligibility of cage-level consumption for sex stratification

- All 7 included male cages contain one recorded sex in the bottle-volume file and one recorded sex among primary weight mice.
...
- Male cage N: Water 2, Sucrose 3, Allulose 2.
- Mouse rows (11 mice total) appear only as pale descriptive points in body-weight trajectories; mice do not replace cages for inference.
...
- Male, Day-6 cumulative cage consumption (mL/cage): one-way ANOVA p=0.229937165718; exact cage-label sensitivity p=0.152380952381 (210 allocations).
- Male, Day-6 cage-mean body-weight change (%): one-way ANOVA p=0.0487111442564; exact cage-label sensitivity p=0.0666666666667 (210 allocations).
