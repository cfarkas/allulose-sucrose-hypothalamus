...
def draw(result, spanish=False):
    ...
    # Metric definitions and benchmark scope are stated in the bilingual legends.
    fig.canvas.draw()
    return fig, axes
