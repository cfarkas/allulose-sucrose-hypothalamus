#!/usr/bin/env python3
"""Render Figure S1 male single-bottle outcomes and live panel A-D crops."""
...
DEFAULT_OUTPUT = PAPER_ROOT / "FigS1"

FIGURE_NUMBER = "S1"
TARGET_SEX = "Male"
STEM_NAME = "Figure_S1_single_bottle_male"
...
OUTPUT_PRODUCER = "Paper/scripts/FigS1/02_make_figure_s1_male.py"
PANEL_MAP = {
...
def write_spanish_panel_legends(output_dir: Path) -> None:
    panels = {
        "A": "Trayectorias masculinas de consumo por jaula desde el día 1 hasta el día 6; las líneas gruesas y bandas resumen jaulas con el mismo peso.",
        "B": "Consumo por jaula masculina en el día 6; se muestra ANOVA de una vía y comparaciones exactas con ajuste de Holm.",
        "C": "Cambio de peso corporal masculino desde basal. Los puntos de ratón son descriptivos y la inferencia permanece al nivel de jaula.",
        "D": "Cambio medio de peso corporal por jaula masculina en el día 6; se muestra ANOVA de una vía y comparaciones exactas con ajuste de Holm.",
    }
